...
typedef struct st_zephyros_coordinates			
{
	...
	//ECEF
	double	ecef_xyzt[4];
	double 	ecef_radar_location_xyzt[4];
	...
	double	ref_wgs84_h;
	double	enu_xyzt[4];
	double  enu_radar_location_xyzt[4];
	...
	double	radar_enu_dir[4]; //radar_enu_dx, radar_enu_dy, radar_enu_dz
	...
	double	radar_pol_hor_dir[4];
	double	radar_pol_ver_dir[4];
