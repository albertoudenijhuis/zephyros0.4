...
SWIGINTERN PyObject *_wrap_windfield(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "windfield", 9, 9, swig_obj)) SWIG_fail;
  res1 = SWIG_AsCharArray(swig_obj[0], temp1, 8192);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "windfield" "', argument " "1"" of type '" "char [8192]""'");
  }
  arg1 = (char *)(temp1);
  res2 = SWIG_AsCharArray(swig_obj[1], temp2, 8192);
  if (!SWIG_IsOK(res2)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "windfield", _wrap_windfield, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
