...
/*-----------------------------------------------
              @(target):= _wrapwindfield.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__wrapwindfield

#else
#  define SWIG_init    init_wrapwindfield

#endif
#define SWIG_name    "_wrapwindfield"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_windfield(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:windfield",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  res1 = SWIG_AsCharArray(obj0, temp1, 8192);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "windfield" "', argument " "1"" of type '" "char [8192]""'");
  }
  arg1 = (char *)(temp1);
  res2 = SWIG_AsCharArray(obj1, temp2, 8192);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "windfield" "', argument " "2"" of type '" "char [8192]""'");
  }
  arg2 = (char *)(temp2);
  {
    npy_intp size[1] = {
  ...
  result = (double)my_windfield(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"windfield", _wrap_windfield, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
