...
for myway in [
    ...
    measurements_filename = "../../wrapradarfilter/python/data/scanning_"+myway+"_additional_output.zout"
    additional_output_filename = "./data/scanning_"+myway+"_additional_output.zout"
    ...
    for plot in [
        ...
        plt.savefig('plots_scanning/scanning_'+myway + "_"+plot+"_.png")
        plt.close(fig)
